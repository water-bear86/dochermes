...
export function App(): ReactElement {
  ...
  return (
    <main className="shell">
      <TopbarPanel statusText={statusText} />
      <HermesStatusPanel
        statusText={hermesStatusText}
        summary={hermesHeartbeat.summary}
        checkedAt={hermesHeartbeat.checkedAt}
        isChecking={isCheckingHermes}
        onCheck={() => {
          void runHermesHeartbeat();
        }}
      />
      <CoachStatePanel armed={settings.armed} onToggle={toggleArmed} />
      <CaptureTargetPanel
        selectedLabel={selectedLabel}
        canSelect={requestState === 'idle'}
        canUnpair={requestState === 'idle' && Boolean(selectedSource)}
        onSelect={() => loadSources('pair')}
        onUnpair={() => {
          setSettings((current) => ({
            ...current,
            pairedWindow: undefined
      ...
      <DiagnosticsPanel
        ...
        copiedDiagnosticId={copiedDiagnosticId}
        formatTiming={formatTiming}
        onClearHistory={clearDiagnosticsHistory}
      ...
      <RequestPreviewPanel
        preview={
          requestPreview
            ? {
                destinationOrigin: requestPreview.destinationOrigin,
                dataSharingScope: requestPreview.dataSharingScope,
                privacyPreset: settings.privacy.preset,
                payloadClasses: requestPreview.payloadClasses,
                localOnlyClasses: requestPreview.localOnlyClasses
              }
            : undefined
        }
      />
      ...
      <QuestionPanel
        questionRef={questionTextAreaRef}
        question={question}
        canAsk={canAsk}
      ...
      <TradeCardPanel
        tradeCard={tradeCard}
        noteText={tradeCardNoteText}
        response={response}
        requestMetrics={requestMetrics}
        formatTiming={formatTiming}
        onNoteChange={setTradeCardNoteText}
        onAction={persistTradeCardDecision}
      />
